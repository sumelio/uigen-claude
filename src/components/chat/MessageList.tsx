  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-12rem)] px-4 text-center">
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-orange-50 mb-4 shadow-sm">
          <Bot className="h-7 w-7 text-orange-600" />
        </div>
        <p className="text-orange-600 font-semibold text-lg mb-2">Start a conversation to generate React components</p>
